...
\begin{multicols}{4} % This is how many columns your poster will be broken into, a poster with many figures may benefit from less columns whereas a text-heavy poster benefits from more
  ...
  \subsection*{Down-regulation time courses are also well fit by the model}

  \begin{minipage}[t]{1.0\linewidth}
    \includegraphics[width=\figwidth]{At2g41250-NPF47}
    \captionof{figure}{
      \textit{STM} has a number of strongly down-regulated targets; these two GR-STM targets are particularly well fit by the model. (RNA-seq data.)
    }
  \end{minipage}
  ...
  \begin{minipage}[t]{1.0\linewidth}
    ...
    \captionof{figure}{
      \textit{HAT22} is a self-regulating target of \textit{REV} which is also a TF. \textit{ERDJ3A} is a possible \textit{down}-regulated target of \textit{HAT22} which returns
